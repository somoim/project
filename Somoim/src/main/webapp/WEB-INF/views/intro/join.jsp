...
- 시행일: 2017년 03월 13일 
			...
			<form >	
				...
				<div class="form-group">
					<label>관심사</label>
					<div class="input-group">
						<input type="checkbox" name="category" value="아웃도어/여행" id="check1"><label for="check1">아웃도어/여행</label> 
						<input type="checkbox" name="category" value="운동/스포츠" id="check2"><label for="check2">운동/스포츠</label>
						<input type="checkbox" name="category" value="인문학/책/글" id="check3"><label for="check3">인문학/책/글</label> 
						<input type="checkbox" name="category" value="외국/언어" id="check4"><label for="check4">외국/언어</label>
						<input type="checkbox" name="category" value="문화/공연" id="check5"><label for="check5">문화/공연</label> 
						<input type="checkbox" name="category" value="음악/악기" id="check6"><label for="check6">음악/악기</label> 
						<input type="checkbox" name="category" value="공예/만들기" id="check7"><label for="check7">공예/만들기</label> 
						<input type="checkbox" name="category" value="댄스/무용" id="check8"><label for="check8">댄스/무용</label> 
						<input type="checkbox" name="category" value="봉사활동" id="check9"><label for="check9">봉사활동</label> 
						<input type="checkbox" name="category" value="사교/인맥" id="check10"><label for="check10">사교/인맥</label> 
						<input type="checkbox" name="category" value="차/오토바이" id="check11"><label for="check11">차/오토바이</label> 
						<input type="checkbox" name="category" value="사진" id="check12"><label for="check12">사진</label> 
						<input type="checkbox" name="category" value="야구관람" id="check13"><label for="check13">야구관람</label> 
						<input type="checkbox" name="category" value="게임/오락" id="check14"><label for="check14">게임/오락</label> 
						<input type="checkbox" name="category" value="요리/제조" id="check15"><label for="check15">요리/제조</label> 
						<input type="checkbox" name="category" value="반려동물" id="check16"><label for="check16">반려동물</label> 
						<input type="checkbox" name="category" value="가족/결혼" id="check17"><label for="check17">가족/결혼</label> 
						<input type="checkbox" name="category" value="자유주제" id="check18"><label for="check18">자유주제</label> 
					</div>
				</div>
